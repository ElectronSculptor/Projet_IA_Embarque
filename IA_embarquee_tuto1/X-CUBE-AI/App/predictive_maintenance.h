/**
  ...
  ******************************************************************************
  */
#ifndef AI_PREDICTIVE_MAINTENANCE_H
#define AI_PREDICTIVE_MAINTENANCE_H

#include "predictive_maintenance_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_PREDICTIVE_MAINTENANCE_MODEL_NAME          "predictive_maintenance"
#define AI_PREDICTIVE_MAINTENANCE_ORIGIN_MODEL_NAME   "modele_prediction_panne"

/******************************************************************************/
#define AI_PREDICTIVE_MAINTENANCE_ACTIVATIONS_ALIGNMENT   (4)
#define AI_PREDICTIVE_MAINTENANCE_INPUTS_IN_ACTIVATIONS   (4)
#define AI_PREDICTIVE_MAINTENANCE_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_PREDICTIVE_MAINTENANCE_IN_NUM        (1)

AI_DEPRECATED
#define AI_PREDICTIVE_MAINTENANCE_IN \
  ai_predictive_maintenance_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_PREDICTIVE_MAINTENANCE_IN_SIZE { \
  AI_PREDICTIVE_MAINTENANCE_IN_1_SIZE, \
}
#define AI_PREDICTIVE_MAINTENANCE_IN_SIZE_BYTES { \
  AI_PREDICTIVE_MAINTENANCE_IN_1_SIZE_BYTES, \
}
#define AI_PREDICTIVE_MAINTENANCE_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_PREDICTIVE_MAINTENANCE_IN_1_CHANNEL     (6)
#define AI_PREDICTIVE_MAINTENANCE_IN_1_SIZE        (6)
#define AI_PREDICTIVE_MAINTENANCE_IN_1_SIZE_BYTES  (24)

/******************************************************************************/
#define AI_PREDICTIVE_MAINTENANCE_OUT_NUM       (1)

AI_DEPRECATED
#define AI_PREDICTIVE_MAINTENANCE_OUT \
  ai_predictive_maintenance_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_PREDICTIVE_MAINTENANCE_OUT_SIZE { \
  AI_PREDICTIVE_MAINTENANCE_OUT_1_SIZE, \
}
#define AI_PREDICTIVE_MAINTENANCE_OUT_SIZE_BYTES { \
  AI_PREDICTIVE_MAINTENANCE_OUT_1_SIZE_BYTES, \
}
#define AI_PREDICTIVE_MAINTENANCE_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_PREDICTIVE_MAINTENANCE_OUT_1_CHANNEL     (5)
#define AI_PREDICTIVE_MAINTENANCE_OUT_1_SIZE        (5)
#define AI_PREDICTIVE_MAINTENANCE_OUT_1_SIZE_BYTES  (20)

/******************************************************************************/
#define AI_PREDICTIVE_MAINTENANCE_N_NODES (8)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup predictive_maintenance
 ...
 * @ingroup predictive_maintenance
 ...
 * @ref ai_predictive_maintenance_create. Both the activations memory buffer 
 ...
 * using @ref ai_predictive_maintenance_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_predictive_maintenance_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_predictive_maintenance_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_PREDICTIVE_MAINTENANCE_*
 * defines into file @ref predictive_maintenance.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_predictive_maintenance_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_PREDICTIVE_MAINTENANCE_H */
